...
DOCUMENTATION = '''
---
module: cisco_ucs_vmedia_policy
short_description: configures vmedia policy on a cisco ucs server
version_added: 0.9.0.0
description:
   -  configures vmedia policy on a cisco ucs server
options:
    state:
        description:
    ...
    mounts:
        version_added: "1.0(1e)"
        description: list of vmedia mounts
...
def setup(server, module):
    ...
    try:
        result["changed"] = setup_vmedia_policy(server, module)
